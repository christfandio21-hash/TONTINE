...
import type { Tontine, TontineMember, Profile, Category, Contribution, CashWithdrawal, Loan, LoanSource, LoanRepayment, Payout, InterestDistribution } from '../types/database';
